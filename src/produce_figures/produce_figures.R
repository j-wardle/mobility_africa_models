...
pred_mob1 <- readRDS("lo_res_gravity_matrix1_numbers.rds") # to plot the lo res fit predictions
pred_mob2 <- readRDS("lo_res_gravity_matrix2_numbers.rds") # to plot the lo res fit predictions
